...
var commonLoaders = [{
  ...
  test: /\.(png|jpg|jpeg|gif|svg|woff|woff2|eot|otf|ttf|cur)$/,
  loader: 'url',
  query: {
    name: '[hash].[ext]',
    limit: 10000,
...
module.exports = [
  webpackConfigMerger(appConfig, commonWebpackConfig.preLoaders(), commonWebpackConfig.vendorChunks()),
  webpackConfigMerger(serverConfig, commonWebpackConfig.preLoaders())
];